(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apidomNsA2A1 = {}));
	...
	*      isNotNil(7); //=> true
	*/
	var complement = /*#__PURE__*/ lift(/* @__PURE__ */ _curry1(function not(a) {
		return !a;
	}));
	//#endregion
	...
	*/
	var isUndefined = equals(always(void 0)());
	//#endregion
	...
	* RA.isEmptyArray('42'); // => false
	*/
	var isEmptyArray = both(curryN(1, isFunction(Array.isArray) ? Array.isArray : pipe(type, identical("Array"))), isEmpty);
	//#endregion
	...
	*/
	var isNonEmptyString = allPass([
		isString,
		complement(curryN(1, both(isNotNull, either(isOfTypeObject, isFunction)))),
		isNotEmpty
	]);
	//#endregion
	...
	*/
	...
	var import_minim = (/* @__PURE__ */ __commonJSMin(((exports) => {
	...
	* @public
	*/
	var ParseResult = class extends import_minim.ArrayElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	*/
	...
	var import_aggregate_error = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	* @public
	*/
	var getNodeType$2 = (node) => node === null || node === void 0 ? void 0 : node.type;
	/**
	* @public
	*/
	var isNode$1 = (node) => typeof getNodeType$2(node) === "string";
	/**
	* @public
	*/
	...
	* @public
	*/
	var mergeAll = (visitors, { visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$2, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, exposeEdits = false } = {}) => {
	...
	var mergeAllAsync = (visitors, { visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$2, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, exposeEdits = false } = {}) => {
		const skipSymbol = Symbol("skip");
		const skipping = new Array(visitors.length).fill(skipSymbol);
		return {
	...
	*  @public
	*/
	var visit$2 = (root, visitor, { keyMap = null, state = {}, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$2, nodePredicate = isNode$1, nodeCloneFn = cloneNode$1, detectCycles = true, detectCyclesCallback = null } = {}) => {
	...
	*/
	visit$2[Symbol.for("nodejs.util.promisify.custom")] = async (root, visitor, { keyMap = null, state = {}, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$2, nodePredicate = isNode$1, nodeCloneFn = cloneNode$1, detectCycles = true, detectCyclesCallback = null } = {}) => {
		const visitorKeys = keyMap || {};
		let stack;
		let inArray = Array.isArray(root);
		let keys = [root];
	...
	*/
	...
	var isNode = pipe(getNodeType$1, isString);
	/**
	* @public
	*/
	var keyMapDefault$1 = {
	...
	*/
	...
	var refract$2 = (value, { Type, plugins = [] }) => {
		...
		*/
		return dispatchPluginsSync(element, plugins, {
			toolboxCreator: createToolbox$1,
			visitorOptions: { nodeTypeGetter: getNodeType$1 }
		});
	};
	...
	ParseResult.refract = createRefractor$1(ParseResult);
	//#endregion
	...
	*/
	...
	//#endregion
	//#region src/elements/AgentCard.ts
	/**
	* @public
	*
	...
	*/
	...
	//#endregion
	//#region src/elements/AgentCapabilities.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/AgentExtension.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/AgentProvider.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/AgentInterface.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/AgentSkill.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/AgentCardSignature.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/SecurityRequirement.ts
	/**
	* @public
	*
	...
	*/
	...
	//#endregion
	//#region src/elements/SecurityScheme.ts
	/**
	* @public
	*
	...
	*/
	...
	//#endregion
	//#region src/elements/APIKeySecurityScheme.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/HTTPAuthSecurityScheme.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/MutualTlsSecurityScheme.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/OAuth2SecurityScheme.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/OpenIdConnectSecurityScheme.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/OAuthFlows.ts
	/**
	* @public
	*
	...
	*/
	...
	//#endregion
	//#region src/elements/AuthorizationCodeOAuthFlow.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/ClientCredentialsOAuthFlow.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/DeviceCodeOAuthFlow.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/StringList.ts
	/**
	* @public
	*
	...
	*/
	...
	//#endregion
	//#region src/refractor/visitors/Visitor.ts
	/**
	* @public
	*/
	var Visitor = class {
	...
	//#endregion
	//#region src/refractor/visitors/FallbackVisitor.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/SpecificationVisitor.ts
	/**
	* @public
	*/
	var SpecificationVisitor = class extends Visitor {
		...
		toRefractedElement(specPath, element, options = {}) {
			...
			*/
			...
			if (visitor instanceof FallbackVisitor && visitor?.constructor === FallbackVisitor) return cloneDeep(element);
			visit$1(element, visitor, options);
			return visitor.element;
		}
	};
	//#endregion
	//#region src/refractor/predicates.ts
	...
	*/
	...
	//#endregion
	//#region src/refractor/visitors/generics/FixedFieldsVisitor.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/agent-card/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/agent-capabilities/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/agent-extension/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/agent-provider/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/agent-interface/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/agent-skill/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/agent-card-signature/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/security-requirement/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/security-scheme/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/api-key-security-scheme/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/http-auth-security-scheme/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/mutual-tls-security-scheme/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/oauth2-security-scheme/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/open-id-connect-security-scheme/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/oauth-flows/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/authorization-code-oauth-flow/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/client-credentials-oauth-flow/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/device-code-oauth-flow/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/string-list/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/nces/Skills.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/SkillsVisitor.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/nces/Signatures.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/SignaturesVisitor.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/nces/SupportedInterfaces.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/SupportedInterfacesVisitor.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/nces/SecurityRequirements.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/SecurityRequirementsVisitor.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/nces/Extensions.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/agent-capabilities/ExtensionsVisitor.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/nces/SecuritySchemes.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/generics/PatternedFieldsVisitor.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/generics/MapVisitor.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/SecuritySchemesVisitor.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/a2a-1/security-requirement/SchemesVisitor.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/specification.ts
	/**
	...
	*/
	...
	//#endregion
	//#region src/traversal/visitor.ts
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region src/refractor/toolbox.ts
	var createToolbox = () => {
	...
	//#endregion
	//#region src/refractor/canonicalize.ts
	/**
	...
	*/
	...
	//#endregion
	//#region src/refractor/plugins/replace-empty-element.ts
	/**
	...
	*/
	var isEmptyElement = (element) => isStringElement(element) && includesClasses(["yaml-e-node", "yaml-e-scalar"], element);
	var schema = {
		A2aAgentCard1Element: {
			provider(...args) {
				return new AgentProvider(...args);
			},
			capabilities(...args) {
				return new AgentCapabilities(...args);
			},
			defaultInputModes(...args) {
				return new import_minim.ArrayElement(...args);
			},
			defaultOutputModes(...args) {
				return new import_minim.ArrayElement(...args);
			},
			supportedInterfaces(...args) {
				return new SupportedInterfaces(...args);
			},
			skills(...args) {
				return new Skills(...args);
			},
			securitySchemes(...args) {
				return new SecuritySchemes(...args);
			},
			securityRequirements(...args) {
				return new SecurityRequirements(...args);
			},
			signatures(...args) {
				return new Signatures(...args);
			}
		},
		AgentCapabilitiesElement: { extensions(...args) {
			return new Extensions(...args);
		} },
		AgentExtensionElement: { params(...args) {
			return new import_minim.ObjectElement(...args);
		} },
		AgentSkillElement: {
			tags(...args) {
				return new import_minim.ArrayElement(...args);
		...
		SecuritySchemeElement: {
			apiKeySecurityScheme(...args) {
				return new APIKeySecurityScheme(...args);
			},
			httpAuthSecurityScheme(...args) {
				return new HTTPAuthSecurityScheme(...args);
			},
			mtlsSecurityScheme(...args) {
				return new MutualTlsSecurityScheme(...args);
			},
			oauth2SecurityScheme(...args) {
				return new OAuth2SecurityScheme(...args);
			},
			openIdConnectSecurityScheme(...args) {
				return new OpenIdConnectSecurityScheme(...args);
			}
		},
		Oauth2SecuritySchemeElement: { flows(...args) {
			return new OAuthFlows(...args);
		} },
		OauthFlowsElement: {
			authorizationCode(...args) {
				return new AuthorizationCodeOAuthFlow(...args);
			},
			clientCredentials(...args) {
				return new ClientCredentialsOAuthFlow(...args);
			},
			deviceCode(...args) {
				return new DeviceCodeOAuthFlow(...args);
			}
		},
		AuthorizationCodeOAuthFlowElement: { scopes(...args) {
			return new import_minim.ObjectElement(...args);
		} },
		ClientCredentialsOAuthFlowElement: { scopes(...args) {
			return new import_minim.ObjectElement(...args);
		} },
		DeviceCodeOAuthFlowElement: { scopes(...args) {
			return new import_minim.ObjectElement(...args);
		} },
		SecurityRequirementElement: { schemes(...args) {
			return new import_minim.ObjectElement(...args);
		} },
		[Skills.primaryClass]: { "<*>": function asterisk(...args) {
			return new AgentSkill(...args);
		} },
		[Signatures.primaryClass]: { "<*>": function asterisk(...args) {
			return new AgentCardSignature(...args);
		} },
		[SupportedInterfaces.primaryClass]: { "<*>": function asterisk(...args) {
			return new AgentInterface(...args);
		} },
		[SecurityRequirements.primaryClass]: { "<*>": function asterisk(...args) {
			return new SecurityRequirement(...args);
		} },
		[Extensions.primaryClass]: { "<*>": function asterisk(...args) {
			return new AgentExtension(...args);
		} },
		[SecuritySchemes.primaryClass]: { "[key: *]": function key(...args) {
			return new SecurityScheme(...args);
		} },
		"security-requirement-schemes": { "[key: *]": function key(...args) {
			return new import_minim.ArrayElement(...args);
		} }
	};
	var findElementFactory = (ancestor, keyName) => {
		const keyMapping = schema[getNodeType(ancestor)] || schema[serializer(ancestor.classes.first)];
	...
	* @public
	*/
	var plugin = () => () => ({ visitor: { StringElement(element, key, parent, path, ancestors) {
		...
		return assignSourceMap(elementFactory.call({ context }, void 0, cloneDeep(element.meta), cloneDeep(element.attributes)), element);
	} } });
	//#endregion
	//#region src/refractor/visitors/SpecificationExtensionVisitor.ts
	/**
	* @public
	*/
	var SpecificationExtensionVisitor = class extends SpecificationVisitor {
	...
	exports.APIKeySecuritySchemeElement = APIKeySecurityScheme;
	exports.AgentCapabilitiesElement = AgentCapabilities;
	exports.AgentCardElement = AgentCard;
	exports.AgentCardSignatureElement = AgentCardSignature;
	exports.AgentExtensionElement = AgentExtension;
	exports.AgentInterfaceElement = AgentInterface;
	exports.AgentProviderElement = AgentProvider;
	exports.AgentSkillElement = AgentSkill;
	exports.AuthorizationCodeOAuthFlowElement = AuthorizationCodeOAuthFlow;
	exports.ClientCredentialsOAuthFlowElement = ClientCredentialsOAuthFlow;
	exports.DeviceCodeOAuthFlowElement = DeviceCodeOAuthFlow;
	exports.ExtensionsElement = Extensions;
	exports.FallbackVisitor = FallbackVisitor;
	exports.FixedFieldsVisitor = FixedFieldsVisitor;
	exports.HTTPAuthSecuritySchemeElement = HTTPAuthSecurityScheme;
	exports.MapVisitor = MapVisitor;
	exports.MutualTlsSecuritySchemeElement = MutualTlsSecurityScheme;
	exports.OAuth2SecuritySchemeElement = OAuth2SecurityScheme;
	exports.OAuthFlowsElement = OAuthFlows;
	exports.OpenIdConnectSecuritySchemeElement = OpenIdConnectSecurityScheme;
	exports.PatternedFieldsVisitor = PatternedFieldsVisitor;
	exports.SecurityRequirementElement = SecurityRequirement;
	exports.SecurityRequirementsElement = SecurityRequirements;
	exports.SecuritySchemeElement = SecurityScheme;
	exports.SecuritySchemesElement = SecuritySchemes;
	exports.SignaturesElement = Signatures;
	exports.SkillsElement = Skills;
	exports.SpecificationExtensionVisitor = SpecificationExtensionVisitor;
	exports.SpecificationVisitor = SpecificationVisitor;
	exports.StringListElement = StringList;
	exports.SupportedInterfacesElement = SupportedInterfaces;
	exports.Visitor = Visitor;
	exports.createRefractor = createRefractor;
	exports.default = a2a1;
	exports.getNodeType = getNodeType;
	exports.isA2ASpecificationExtension = isA2ASpecificationExtension;
	exports.isAPIKeySecuritySchemeElement = isAPIKeySecuritySchemeElement;
	exports.isAgentCapabilitiesElement = isAgentCapabilitiesElement;
	exports.isAgentCardElement = isAgentCardElement;
	exports.isAgentCardSignatureElement = isAgentCardSignatureElement;
	exports.isAgentExtensionElement = isAgentExtensionElement;
	exports.isAgentInterfaceElement = isAgentInterfaceElement;
	exports.isAgentProviderElement = isAgentProviderElement;
	exports.isAgentSkillElement = isAgentSkillElement;
	exports.isArrayElement = isArrayElement;
	exports.isAuthorizationCodeOAuthFlowElement = isAuthorizationCodeOAuthFlowElement;
	exports.isBooleanElement = isBooleanElement;
	exports.isClientCredentialsOAuthFlowElement = isClientCredentialsOAuthFlowElement;
	exports.isDeviceCodeOAuthFlowElement = isDeviceCodeOAuthFlowElement;
	exports.isElement = isElement;
	exports.isExtensionsElement = isExtensionsElement;
	exports.isHTTPAuthSecuritySchemeElement = isHTTPAuthSecuritySchemeElement;
	exports.isLinkPrimitiveElement = isLinkElement;
	exports.isMemberElement = isMemberElement;
	exports.isMutualTlsSecuritySchemeElement = isMutualTlsSecuritySchemeElement;
	exports.isNullElement = isNullElement;
	exports.isNumberElement = isNumberElement;
	exports.isOAuth2SecuritySchemeElement = isOAuth2SecuritySchemeElement;
	exports.isOAuthFlowsElement = isOAuthFlowsElement;
	exports.isObjectElement = isObjectElement;
	exports.isOpenIdConnectSecuritySchemeElement = isOpenIdConnectSecuritySchemeElement;
	exports.isRefElement = isRefElement;
	exports.isSecurityRequirementElement = isSecurityRequirementElement;
	exports.isSecurityRequirementsElement = isSecurityRequirementsElement;
	exports.isSecuritySchemeElement = isSecuritySchemeElement;
	exports.isSecuritySchemesElement = isSecuritySchemesElement;
	exports.isSignaturesElement = isSignaturesElement;
	exports.isSkillsElement = isSkillsElement;
	exports.isStringElement = isStringElement;
	exports.isStringListElement = isStringListElement;
	exports.isSupportedInterfacesElement = isSupportedInterfacesElement;
