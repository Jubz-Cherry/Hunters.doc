 ...
 * @public
 */
import { toValue, isElement, isObjectElement, isArrayElement, isStringElement } from '@swagger-api/apidom-core';
 ...
 * @public
 */
export const canonicalizeKeys = element => {
  if (isObjectElement(element)) {
    element.content.forEach(member => {
      ...
      if (isStringElement(key)) {
        const canonicalKey = SNAKE_TO_CAMEL[toValue(key)];
