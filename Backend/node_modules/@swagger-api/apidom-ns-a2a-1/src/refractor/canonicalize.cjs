...
exports.default = exports.canonicalizeKeys = void 0;
 ...
 * @public
 */
const canonicalizeKeys = element => {
  if ((0, _apidomCore.isObjectElement)(element)) {
    element.content.forEach(member => {
      const {
        key,
        value
      } = member;
      if ((0, _apidomCore.isStringElement)(key)) {
        const canonicalKey = SNAKE_TO_CAMEL[(0, _apidomCore.toValue)(key)];
      ...
      if ((0, _apidomCore.isElement)(value)) {
        canonicalizeKeys(value);
      }
    });
  } else if ((0, _apidomCore.isArrayElement)(element)) {
...
exports.canonicalizeKeys = canonicalizeKeys;
var _default = exports.default = canonicalizeKeys;