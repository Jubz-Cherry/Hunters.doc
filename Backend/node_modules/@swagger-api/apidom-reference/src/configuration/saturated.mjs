...
import OpenAPI3_2ResolveStrategy from "../resolve/strategies/openapi-3-2/index.mjs";
...
import OpenAPIJSON3_2Parser from "../parse/parsers/openapi-json-3-2/index.mjs";
import OpenAPIYAML3_2Parser from "../parse/parsers/openapi-yaml-3-2/index.mjs";
import AsyncAPIJSON2Parser from "../parse/parsers/asyncapi-json-2/index.mjs";
import AsyncAPIJSON3Parser from "../parse/parsers/asyncapi-json-3/index.mjs";
import AsyncAPIYAML2Parser from "../parse/parsers/asyncapi-yaml-2/index.mjs";
import AsyncAPIYAML3Parser from "../parse/parsers/asyncapi-yaml-3/index.mjs";
...
import A2AJSON1Parser from "../parse/parsers/a2a-json-1/index.mjs";
import A2AYAML1Parser from "../parse/parsers/a2a-yaml-1/index.mjs";
...
import OpenAPI3_2DereferenceStrategy from "../dereference/strategies/openapi-3-2/index.mjs";
import AsyncAPI2DereferenceStrategy from "../dereference/strategies/asyncapi-2/index.mjs";
import AsyncAPI3DereferenceStrategy from "../dereference/strategies/asyncapi-3/index.mjs";
import OpenAPI3_1BundleStrategy from "../bundle/strategies/openapi-3-1/index.mjs";
import OpenAPI3_2BundleStrategy from "../bundle/strategies/openapi-3-2/index.mjs";
...
options.parse.parsers = [new OpenAPIJSON2Parser({
  ...
  allowEmpty: true,
  sourceMap: false
}), new AsyncAPIJSON3Parser({
  allowEmpty: true,
  sourceMap: false
}), new AsyncAPIYAML3Parser({
  allowEmpty: true,
  sourceMap: false
...
options.resolve.strategies = [new OpenAPI2ResolveStrategy(), new OpenAPI3_0ResolveStrategy(), new OpenAPI3_1ResolveStrategy(), new OpenAPI3_2ResolveStrategy(), new AsyncAPI2ResolveStrategy(), new ApiDOMResolveStrategy()];
options.dereference.strategies = [new OpenAPI2DereferenceStrategy(), new OpenAPI3_0DereferenceStrategy(), new OpenAPI3_1DereferenceStrategy(), new OpenAPI3_2DereferenceStrategy(), new AsyncAPI2DereferenceStrategy(), new AsyncAPI3DereferenceStrategy(), new ApiDOMDereferenceStrategy()];
